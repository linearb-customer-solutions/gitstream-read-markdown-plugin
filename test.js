...
// For testing, we need to access internal functions - in GitStream this wouldn't be needed
const fs = require('fs');
...
function readMarkdown(filePath, options = {}) {
  // This is just for testing - real GitStream plugin doesn't need to expose this
